...
def check_bot_contract(bot_text: str, env_example_text: str) -> None:
    ...
    record("Apple ID manual code entry flow exists", "✍️ Внести Apple ID код вручную" in bot_text and "APPLE_ID_MANUAL_CODE_INPUT" in bot_text and "order_manual_code:" in bot_text and 'fulfillment_status="issued"' in bot_text and 'status="issued"' in bot_text and "auto_fulfillment_client_text(updated, True)" in bot_text)
