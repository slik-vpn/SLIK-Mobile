...
def check_apple_id_rub_market_pricing(bot_text: str) -> None:
    ...
    record("CryptoBot Apple ID amount uses price_rub helper", "apple_id_payment_amount_rub(plan)" in cryptobot_branch and "price_rub <= 0" in cryptobot_branch)
    record("CryptoBot round_crypto_amount_up helper exists", "def round_crypto_amount_up" in bot_text and "math.ceil" in function_block(bot_text, "round_crypto_amount_up"))
    ...
    record("CryptoBot payment_details stores invoice calculation", all(x in function_block(bot_text, "cryptobot_payment_details") for x in ("price_rub", "cryptobot_amount", "cryptobot_asset", "usd_rub_rate_used", "usd_rub_rate_source")))
    ...
    record("CryptoBot payment chat gets created and paid notifications", "notify_cryptobot_invoice_created" in cryptobot_branch and "notify_cryptobot_invoice_paid" in callback_branch_block(bot_text, 'elif data.startswith("check_payment_")'))
