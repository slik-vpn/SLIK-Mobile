...
def check_apple_id_rub_market_pricing(bot_text: str) -> None:
    ...
    record("order/purchase/payment endpoints are skipped", "multitransfer_url_is_safe_get" in bot_text and "purchase" in bot_text and "payment" in bot_text and "order" in bot_text)
